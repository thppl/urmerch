...
<head>
    ...
    <title>Urmerch - Official Merchandise</title>
    ...
    <link rel="stylesheet" href="<?=base_url('assets/css/pnotify.custom.min.css');?>" type="text/css">
    ...
    <![endif]-->
    <style type="text/css">
        .inputnoscroll::-webkit-outer-spin-button,
        .inputnoscroll::-webkit-inner-spin-button {
